...
export class SwcCollectionError extends SwcError {
  constructor(errorCode: number, message: string, error: any | undefined) {
    super('SwcCollectionError', errorCode, message, error);
  }
}
...
export interface IFilmsResolved {
  films?: IFilm[];
  error?: SwcCollectionError;
}
